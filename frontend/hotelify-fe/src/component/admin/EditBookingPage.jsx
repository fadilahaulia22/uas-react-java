...
const EditBookingPage = () => {
    ...
    useEffect(() => {
        const fetchBookingDetails = async () => {
            try {
                const response = await ApiService.getBookingByConfirmationCode(bookingCode); // Fetch booking details using the confirmation code
            ...
            {bookingDetails && (
                <div className="booking-details">
                    ...
                    <div>
                        ...
                        <img src={`http://localhost:4040/images/${bookingDetails.room.roomPhotoUrl}`} alt="Room" />
                    </div>
                    <button
